...
if (isset($_POST['edit'])) {
    ...
    if (!empty($datas->getAllError())) {
        ...
        try {
            ...
            header('Location: ?p=edit.content&id=' . $_GET['id']);
        } catch (Exception $e) {
...
require_once dirname(__DIR__, 3) . DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR . 'admin' . DIRECTORY_SEPARATOR . 'content' . DIRECTORY_SEPARATOR . 'editContent.php';